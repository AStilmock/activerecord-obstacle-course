...
# You can comment out the Ruby example after your AR is working. 
  ...
  it '5. finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Item.where("items.id IN (?)", ids_to_find)
    # ------------------------------------------------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.where("orders.id IN (?)", ids_to_find)
    # ------------------------------------------------------------
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_between_700_and_1000 = Order.where((orders.amount >=700) && (orders.amoutn <= 1000))
    # ------------------------------------------------------------
